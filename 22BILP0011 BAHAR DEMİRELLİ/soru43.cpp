...
//Binary Search, sýralý(sorted) bir veri yapýsý için kullanýlýr. Yani algoritmaya aranan veri ve sýralý bir veri yapýsý verirsiniz. Algoritma da size önceki örnekteki gibi eðer bulunursa aranan verinin indeksini döner
